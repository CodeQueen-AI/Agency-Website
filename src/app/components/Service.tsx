...
const services = [
  { icon: <FaAd className="text-[#1F1235] text-3xl transition-all duration-300 hover:text-white" />, title: "Social Media", description: "Grow your brand on social platforms." },
  { icon: <FaCode className="text-[#1F1235] text-3xl transition-all duration-300 hover:text-white" />, title: "Web Development", description: "Build modern and responsive websites." },
  { icon: <FaChartBar className="text-[#1F1235] text-3xl transition-all duration-300 hover:text-white" />, title: "SEO & Marketing", description: "Optimize your business for search engines." },
  { icon: <FaPaintBrush className="text-[#1F1235] text-3xl transition-all duration-300 hover:text-white" />, title: "Graphic Design", description: "Create stunning visuals and branding." }
];
